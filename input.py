...
class input_data(object):
	...
	def __init__(self):
		...
		self.mortality_rate = 0.1            # [0,1] (probability)
		self.death_after_symptoms = (1.0, 3.0)             # days
		self.incubation_period = (1.0, 4.0)         # days
		self.recovery_after_symptoms = (2.0, 5.0)   # days


		# Action against epidemic
		self.prenventive_confinement = 0.8         # Ratio of population initially confined       
